...
if($res)
{
   ...
   $res1=$obj->storepackage($bookid,$_GET['vid'],$_GET['hid'],$_GET['dest'],$_GET['scount'],$_GET['dcount'],$_GET['mcount'],$_GET['date'],$_GET['days'],$_GET['nov'],$_GET['price']);
	if($res1)
	{
		...
		$nov1=$_GET['nov'];
		$price1=$_GET['price'];
	   echo "<script type='text/javascript'>alert('Please fill out your form');</script>";
...
{
	echo"<script type='text/javascript'>alert('Your package cannot be booked right now');</script>";
