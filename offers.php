...
<body> 
	...
	<!-- add-products -->
						...
						<div class="flip-container">
							<div class="flipper agile-products">
								...
								<div class="back">
									...
									$x=array();
									$x=$vehicleobj->getvehicle($vid);?>Vehicle in package:
									<?php echo $x[0][2];?></p>
        ...
        <br>
		<button  id="123" class="btn btn-default" name="book"  onClick="call.php">Book Package </button>
		<br>
		<br>
		<div id="cale">
		
		<form action="book.php" method="get">
      Date: <input type="text" name="d" id="datepicker">
      <input type="submit" name="ns" value="Book Now">
	  <input type="hidden" name="ab1" value="<?php echo $b; ?>">
	  <input type="hidden" name="ax1" value="<?php echo $x; ?>">
	  <input type="hidden" name="ay1" value="<?php echo $y; ?>">
      </form>
	  <br>
	  <br>
		</div>
...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
	...
	<div class="wthree-order">  
		<img src="images/115.jpg" class="w3order-img" alt=""/>
		<div class="container">
